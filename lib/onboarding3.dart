        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Expanded(
              child: Center(
                child: SizedBox(
                  width: 150.0, // Atur lebar animasi
                  height: 150.0, // Atur tinggi animasi
                  child: Lottie.asset(
                    'animations/ready.json',
                    fit: BoxFit.contain,
                  ),
                ),
              ),
                ...
                children: [
                  ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      ...
                      padding: const EdgeInsets.symmetric(horizontal: 32.0), // Adjust padding to align with the Next button
                    ),
                    child: Text(
                      'Start Donation',
                      style: GoogleFonts.poppins(
