  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          productName,
          style: GoogleFonts.poppins(fontSize: 20, fontWeight: FontWeight.bold), // Menggunakan font Poppins untuk judul
        ),
        backgroundColor: kShrineBlue100, // Menggunakan warna yang sudah didefinisikan dalam colors.dart
      ),
      body: Padding(
        padding: const EdgeInsets.all(16.0), // Memberikan padding sekitar body halaman
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start, // Menyusun elemen-elemen secara vertikal dan rata kiri
          children: [
            ...
            Center(
              child: Image.asset(
                ...
                fit: BoxFit.cover, // Mengatur agar gambar tetap sesuai dengan ukuran yang diberikan
              ),
            ),
            const SizedBox(height: 20.0), // Memberikan jarak antara gambar dan teks
            ...
            Text(
              ...
              style: GoogleFonts.poppins(
                ...
                color: kShrineBlue500, // Menggunakan warna biru yang sudah didefinisikan
              ),
            ),
            const SizedBox(height: 10.0), // Memberikan jarak antara nama produk dan deskripsi
            ...
            const SizedBox(height: 20.0), // Memberikan jarak antara deskripsi dan harga produk
            // Menampilkan harga produk dengan format angka yang sesuai
            Text(
              'Price: Rp. ${NumberFormat('#,##0').format(price)}', // Format harga dengan pemisah ribuan
              style: GoogleFonts.poppins(
                fontSize: 18, // Ukuran font untuk harga
                fontWeight: FontWeight.w600, // Menebalkan font harga
                color: const Color.fromARGB(255, 68, 108, 192), // Warna biru untuk harga
              ),
            ),
